...
const validate_code_dto_1 = require("./dto/validate-code.dto");
...
let PromotionsController = class PromotionsController {
    ...
    validateCode(validateCodeDto) {
        return this.promotionsService.validateCode(validateCodeDto.code, validateCodeDto.cartTotal);
    }
    findAll() {
...
], PromotionsController.prototype, "getActive", null);
__decorate([
    (0, common_1.Post)('promotions/validate-code'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [validate_code_dto_1.ValidateCodeDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)('admin/promotions/:id'),
